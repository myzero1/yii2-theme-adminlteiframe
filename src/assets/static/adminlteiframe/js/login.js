...
$("#mywitch").bootstrapSwitch({
    onSwitchChange: function onSwitchChange(e, data) {
...
$(".ali-form-layout input[type='text']").focus(function(){
    $(this).parents(".form-group").addClass("focus");
});
$(".ali-form-layout input[type='text']").blur(function(){
    if($(this).val()==''){
        $(this).parents(".form-group").removeClass("focus");
    }
});
$(".ali-form-layout input[type='text']").each(function(){
    if ($(this).val() != '') {
        $(this).parents(".form-group").addClass("focus");
    }
});

$(".ali-form-layout input[type='password']").focus(function(){
    $(this).parents(".form-group").addClass("focus");
});
$(".ali-form-layout input[type='password']").blur(function(){
    if($(this).val()==''){
        $(this).parents(".form-group").removeClass("focus");
    }
});
$(".ali-form-layout input[type='password']").each(function(){
    if ($(this).val() != '') {
        $(this).parents(".form-group").addClass("focus");
    }
});
