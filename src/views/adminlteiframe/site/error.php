...
<script>
	...
	console.log(document.getElementById('jParticle').getAttribute('show'));
	console.log(document.getElementById('jParticle').getAttribute('show') == 'true');
	if (document.getElementById('jParticle').getAttribute('show') == 'true') {
		init();
	}
