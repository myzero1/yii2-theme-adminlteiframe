...
class LinkPager extends Widget
{
    ...
    /**
     * @var string the CSS class for the goToButtonCssClass page buttons.
     */
    public $goToLiCssClass = 'goto-li';
    /**
    /**
     * @var string the CSS class for the goToButtonCssClass page buttons.
     */
    public $goToButtonCssClass = 'goto-button';
    /**
     * @var string the CSS class for the goToInputCssClass page buttons.
     */
    public $goToInputCssClass = 'goto-input';
    /**
     * @var string the CSS class for the goToInputCssClass page buttons.
     */
    public $goToButtonLable = '确定';
    /**
    ...
    { 
        ...
        $goToLiCssClass = $this->goToLiCssClass;
        $goToButtonCssClass = $this->goToButtonCssClass;
        $goToInputCssClass = $this->goToInputCssClass;
        $goToButtonLable = $this->goToButtonLable;

        $goHtml = <<<goHtml
            <li class="form {$goToLiCssClass}">
                到第
                <input class="input {$goToInputCssClass}" value="{$goPage}" min="1" max="{$pageCount}" aria-label="页码输入框">
                页
                <span class="go-page {$goToButtonCssClass}" role="button" tabindex="0">{$goToButtonLable}</span>
            </li>
goHtml;
